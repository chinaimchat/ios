...
didCropToImage:(nonnull UIImage *)image withRect:(CGRect)cropRect
    ...
    [[WKAPIClient sharedClient] fileUpload:[NSString stringWithFormat:@"groups/%@/avatar",self.groupNo] data:data fileName:@"avatar.jpg" progress:^(NSProgress * _Nonnull progress) {
