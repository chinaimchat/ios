...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xxxxxxxx/WuKongAdvanced'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xxxxxxxx' => 'taotao@gmail.com' }
  s.source           = { :git => 'https://github.com/taotaoit/WuKongAdvanced.git', :tag => s.version.to_s }
