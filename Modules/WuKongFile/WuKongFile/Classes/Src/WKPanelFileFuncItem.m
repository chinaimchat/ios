...
+ (void)chooseFileForConversationContext:(id<WKConversationContext>)context finishUI:(void (^)(void))finishUI {
...
- (void)onPressed:(UIButton *)btn {
    ...
    [WKPanelFileFuncItem chooseFileForConversationContext:context finishUI:^{
        weakBtn.selected = NO;
    }];
}
- (NSString *)title {
