...
@interface WKDeleteAccountVercodeVC () <UITextFieldDelegate, UIGestureRecognizerDelegate>
...
- (void)viewDidLoad {
    ...
    self.vercodeFd.delegate = self;
    self.vercodeFd.inputAccessoryView = self.numberInputToolbar;
