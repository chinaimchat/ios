...
-(void) showMsg:(NSString*)msg{
    NSString *normalizedMsg = [WKApp normalizedServerErrorMessage:msg];
    CSToastStyle * style = [[CSToastStyle alloc] initWithDefaultStyle];
 
    [style setMessageFont:[UIFont systemFontOfSize:15.0f]];
    
    [self makeToast:normalizedMsg duration:1.0f position:CSToastPositionCenter  style:style];
}
...
-(void) switchHUDError:(NSString*)text {
    ...
    hud.label.text = [WKApp normalizedServerErrorMessage:text];
