...
+ (void)showMsg:(NSString *)msg {
    [self alert:[WKApp normalizedServerErrorMessage:msg]];
}

+(void) alert:(NSString*)msg {
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"" message:[WKApp normalizedServerErrorMessage:msg] preferredStyle:UIAlertControllerStyleAlert];
...
+(void) alert:(NSString*)msg title:(NSString*)title{
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:title message:[WKApp normalizedServerErrorMessage:msg] preferredStyle:UIAlertControllerStyleAlert];
