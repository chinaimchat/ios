...
FOUNDATION_EXPORT NSString *const BUGLY_MODULE_VIEW_CAPTURE;
FOUNDATION_EXPORT NSString *const BUGLY_MODULE_CUSTOM_EVENT;
FOUNDATION_EXPORT NSString *const BUGLY_MODULE_SAFE_EXCEPTION;
